...
# WORKING VERSION: Having trouble controlling 'edge' behavior & 'layout' arrangement.
# I tried everything I could find in their documentation. =
...
**NOTE:** Results are for illustration purposes & should not be interpreted literally:
...
# NOTE for Josh: My regular expression knowledge is limited: 
# Do you know a more elegant way to combine and format RMSEA and 90% CI range in a single column?
# This is not necessary but makes table look tidier.

model_fit <- LatexSummaryTable(cfa_m1_fit,
  keepCols=c("Title", "Parameters", "LL","ChiSqM_Value","ChiSqM_DF", "ChiSqM_PValue",
...
# NOTE for Josh: Which style should we use to access the parameters? 
# *** for consistency ***

# Alternative # loadings_stdyx <- cfa_m1_fit[["results"]][["parameters"]][["stdyx.standardized"]]
